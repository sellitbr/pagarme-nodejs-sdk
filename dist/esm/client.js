...
export class Client {
    constructor(config) {
        ...
        const clonedConfig = Object.assign(Object.assign({}, this._config), { basicAuthCredentials: this._config.basicAuthCredentials || {
...
function withServiceRefererName({ serviceRefererName }) {
    return (rb) => {
        rb.interceptRequest((request) => {
            var _a;
            const headers = (_a = request.headers) !== null && _a !== void 0 ? _a : {};
