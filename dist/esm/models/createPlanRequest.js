 ...
 */
import { array, boolean, dict, lazy, number, object, optional, string, } from '../schema';
import { createPlanItemRequestSchema, } from './createPlanItemRequest';
import { createPricingSchemeRequestSchema, } from './createPricingSchemeRequest';
export const createPlanRequestSchema = object({
    name: ['name', string()],
