 ...
 */
import { bigint, boolean, lazy, number, object, optional, string, } from '../schema';
import { createCardPayloadRequestSchema, } from './createCardPayloadRequest';
...
export const createCreditCardPaymentRequestSchema = object({
