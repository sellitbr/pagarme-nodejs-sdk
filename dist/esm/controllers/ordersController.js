 ...
 */
import { createOrderItemRequestSchema, } from '../models/createOrderItemRequest';
import { createOrderRequestSchema, } from '../models/createOrderRequest';
import { getOrderItemResponseSchema, } from '../models/getOrderItemResponse';
import { getOrderResponseSchema, } from '../models/getOrderResponse';
import { listOrderResponseSchema, } from '../models/listOrderResponse';
import { updateMetadataRequestSchema, } from '../models/updateMetadataRequest';
import { updateOrderItemRequestSchema, } from '../models/updateOrderItemRequest';
import { updateOrderStatusRequestSchema, } from '../models/updateOrderStatusRequest';
...
export class OrdersController extends BaseController {
     ...
     */
    async deleteAllOrderItems(orderId, idempotencyKey, requestOptions) {
     ...
     * @return Response from the API call
     */
    async getOrderItem(orderId, itemId, requestOptions) {
     ...
     * @return Response from the API call
     */
    async updateOrderMetadata(orderId, request, idempotencyKey, requestOptions) {
     ...
     * @return Response from the API call
     */
    async deleteOrderItem(orderId, itemId, idempotencyKey, requestOptions) {
        const req = this.createRequest('DELETE');
        const mapped = req.prepareArgs({
            orderId: [orderId, string()],
            itemId: [itemId, string()],
     ...
     * @return Response from the API call
     */
    async getOrder(orderId, requestOptions) {
        const req = this.createRequest('GET');
     ...
     * @return Response from the API call
     */
    async getOrders(page, size, code, status, createdSince, createdUntil, customerId, requestOptions) {
     ...
     * @return Response from the API call
     */
    async updateOrderItem(orderId, itemId, request, idempotencyKey, requestOptions) {
     ...
     * @return Response from the API call
     */
    async closeOrder(id, request, idempotencyKey, requestOptions) {
        const req = this.createRequest('PATCH');
        const mapped = req.prepareArgs({
            id: [id, string()],
     ...
     * @return Response from the API call
     */
    async createOrder(body, idempotencyKey, requestOptions) {
     ...
     * @return Response from the API call
     */
    async createOrderItem(orderId, request, idempotencyKey, requestOptions) {
