 ...
 */
import { createCancelChargeRequestSchema, } from '../models/createCancelChargeRequest';
import { createCaptureChargeRequestSchema, } from '../models/createCaptureChargeRequest';
import { createChargeRequestSchema, } from '../models/createChargeRequest';
import { createConfirmPaymentRequestSchema, } from '../models/createConfirmPaymentRequest';
import { getChargeResponseSchema, } from '../models/getChargeResponse';
import { getChargesSummaryResponseSchema, } from '../models/getChargesSummaryResponse';
import { listChargesResponseSchema, } from '../models/listChargesResponse';
import { listChargeTransactionsResponseSchema, } from '../models/listChargeTransactionsResponse';
import { updateChargeCardRequestSchema, } from '../models/updateChargeCardRequest';
import { updateChargeDueDateRequestSchema, } from '../models/updateChargeDueDateRequest';
import { updateChargePaymentMethodRequestSchema, } from '../models/updateChargePaymentMethodRequest';
...
export class ChargesController extends BaseController {
     ...
     */
    async updateChargeMetadata(chargeId, request, idempotencyKey, requestOptions) {
     ...
     * @return Response from the API call
     */
    async captureCharge(chargeId, request, idempotencyKey, requestOptions) {
     ...
     * @return Response from the API call
     */
    async getCharge(chargeId, requestOptions) {
     ...
     * @return Response from the API call
     */
    async confirmPayment(chargeId, request, idempotencyKey, requestOptions) {
        const req = this.createRequest('POST');
        const mapped = req.prepareArgs({
            chargeId: [chargeId, string()],
     ...
     * @return Response from the API call
     */
    async getChargeTransactions(chargeId, page, size, requestOptions) {
        const req = this.createRequest('GET');
        const mapped = req.prepareArgs({
            chargeId: [chargeId, string()],
     ...
     * @return Response from the API call
     */
    async updateChargeCard(chargeId, request, idempotencyKey, requestOptions) {
        const req = this.createRequest('PATCH');
        const mapped = req.prepareArgs({
            chargeId: [chargeId, string()],
     ...
     * @return Response from the API call
     */
    async createCharge(request, idempotencyKey, requestOptions) {
     ...
     * @return Response from the API call
     */
    async updateChargePaymentMethod(chargeId, request, idempotencyKey, requestOptions) {
        const req = this.createRequest('PATCH');
        const mapped = req.prepareArgs({
            chargeId: [chargeId, string()],
     ...
     * @return Response from the API call
     */
    async updateChargeDueDate(chargeId, request, idempotencyKey, requestOptions) {
        const req = this.createRequest('PATCH');
        const mapped = req.prepareArgs({
            chargeId: [chargeId, string()],
     ...
     * @return Response from the API call
     */
    async getChargesSummary(status, createdSince, createdUntil, requestOptions) {
     ...
     * @return Response from the API call
     */
    async retryCharge(chargeId, idempotencyKey, requestOptions) {
        const req = this.createRequest('POST');
        const mapped = req.prepareArgs({
            chargeId: [chargeId, string()],
            idempotencyKey: [idempotencyKey, optional(string())],
     ...
     * @return Response from the API call
     */
    async getCharges(page, size, code, status, paymentMethod, customerId, orderId, createdSince, createdUntil, requestOptions) {
     ...
     * @return Response from the API call
     */
    async cancelCharge(chargeId, request, idempotencyKey, requestOptions) {
