 ...
 */
import { getBalanceOperationResponseSchema, } from '../models/getBalanceOperationResponse';
import { listBalanceOperationResponseSchema, } from '../models/listBalanceOperationResponse';
...
export class BalanceOperationsController extends BaseController {
     ...
     */
    async getBalanceOperationById(id, requestOptions) {
     ...
     * @return Response from the API call
     */
    async getBalanceOperations(status, createdSince, createdUntil, recipientId, requestOptions) {
