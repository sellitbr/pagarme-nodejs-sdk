...
import { updateInvoiceStatusRequestSchema, } from '../models/updateInvoiceStatusRequest';
...
export class InvoicesController extends BaseController {
     ...
     */
    async getInvoices(page, size, code, customerId, subscriptionId, createdSince, createdUntil, status, dueSince, dueUntil, customerDocument, requestOptions) {
     ...
     * @return Response from the API call
     */
    async cancelInvoice(invoiceId, idempotencyKey, requestOptions) {
     ...
     * @return Response from the API call
     */
    async updateInvoiceStatus(invoiceId, request, idempotencyKey, requestOptions) {
     ...
     * @return Response from the API call
     */
    async updateInvoiceMetadata(invoiceId, request, idempotencyKey, requestOptions) {
        const req = this.createRequest('PATCH');
        const mapped = req.prepareArgs({
            invoiceId: [invoiceId, string()],
     ...
     * @return Response from the API call
     */
    async getPartialInvoice(subscriptionId, requestOptions) {
     ...
     * @return Response from the API call
     */
    async createInvoice(subscriptionId, cycleId, request, idempotencyKey, requestOptions) {
