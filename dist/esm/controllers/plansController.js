 ...
 */
import { createPlanItemRequestSchema, } from '../models/createPlanItemRequest';
import { createPlanRequestSchema, } from '../models/createPlanRequest';
import { getPlanItemResponseSchema, } from '../models/getPlanItemResponse';
import { getPlanResponseSchema, } from '../models/getPlanResponse';
import { listPlansResponseSchema, } from '../models/listPlansResponse';
import { updateMetadataRequestSchema, } from '../models/updateMetadataRequest';
import { updatePlanItemRequestSchema, } from '../models/updatePlanItemRequest';
import { updatePlanRequestSchema, } from '../models/updatePlanRequest';
...
export class PlansController extends BaseController {
     ...
     */
    async getPlan(planId, requestOptions) {
     ...
     * @return Response from the API call
     */
    async deletePlanItem(planId, planItemId, idempotencyKey, requestOptions) {
     ...
     * @return Response from the API call
     */
    async updatePlanMetadata(planId, request, idempotencyKey, requestOptions) {
     ...
     * @return Response from the API call
     */
    async createPlan(body, idempotencyKey, requestOptions) {
     ...
     * @return Response from the API call
     */
    async updatePlan(planId, request, idempotencyKey, requestOptions) {
     ...
     * @return Response from the API call
     */
    async deletePlan(planId, idempotencyKey, requestOptions) {
        const req = this.createRequest('DELETE');
        const mapped = req.prepareArgs({
            planId: [planId, string()],
            idempotencyKey: [idempotencyKey, optional(string())],
     ...
     * @return Response from the API call
     */
    async getPlans(page, size, name, status, billingType, createdSince, createdUntil, requestOptions) {
     ...
     * @return Response from the API call
     */
    async updatePlanItem(planId, planItemId, body, idempotencyKey, requestOptions) {
        const req = this.createRequest('PUT');
        const mapped = req.prepareArgs({
            planId: [planId, string()],
            planItemId: [planItemId, string()],
     ...
     * @return Response from the API call
     */
    async createPlanItem(planId, request, idempotencyKey, requestOptions) {
     ...
     * @return Response from the API call
     */
    async getPlanItem(planId, planItemId, requestOptions) {
        const req = this.createRequest('GET');
        const mapped = req.prepareArgs({
            planId: [planId, string()],
            planItemId: [planItemId, string()],
