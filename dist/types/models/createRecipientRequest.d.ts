...
import { CreateTransferSettingsRequest } from './createTransferSettingsRequest';
...
export declare const createRecipientRequestSchema: Schema<CreateRecipientRequest>;
