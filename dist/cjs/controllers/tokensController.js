    ...
    TokensController.prototype.getToken = function (id, publicKey, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.appendTemplatePath(templateObject_1 || (templateObject_1 = tslib_1.__makeTemplateObject(["/tokens/", "?appId=", ""], ["/tokens/", "?appId=", ""])), mapped.id, mapped.publicKey);
    ...
    TokensController.prototype.createToken = function (publicKey, request, idempotencyKey, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.appendTemplatePath(templateObject_2 || (templateObject_2 = tslib_1.__makeTemplateObject(["/tokens?appId=", ""], ["/tokens?appId=", ""])), mapped.publicKey);
                req.authenticate(false);
                return [2 /*return*/, req.callAsJson(getTokenResponse_1.getTokenResponseSchema, requestOptions)];
            });
        });
