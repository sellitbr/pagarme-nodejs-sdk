    ...
    RecipientsController.prototype.getWithdrawById = function (recipientId, withdrawalId, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.appendTemplatePath(templateObject_2 || (templateObject_2 = tslib_1.__makeTemplateObject(["/recipients/", "/withdrawals/", ""], ["/recipients/", "/withdrawals/", ""])), mapped.recipientId, mapped.withdrawalId);
                req.authenticate([{ httpBasic: true }]);
    ...
    RecipientsController.prototype.getRecipient = function (recipientId, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.appendTemplatePath(templateObject_3 || (templateObject_3 = tslib_1.__makeTemplateObject(["/recipients/", ""], ["/recipients/", ""])), mapped.recipientId);
                req.authenticate([{ httpBasic: true }]);
                return [2 /*return*/, req.callAsJson(getRecipientResponse_1.getRecipientResponseSchema, requestOptions)];
            });
        });
    ...
    RecipientsController.prototype.getBalance = function (recipientId, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                req = this.createRequest('GET');
                mapped = req.prepareArgs({ recipientId: [recipientId, (0, schema_1.string)()] });
                req.appendTemplatePath(templateObject_4 || (templateObject_4 = tslib_1.__makeTemplateObject(["/recipients/", "/balance"], ["/recipients/", "/balance"])), mapped.recipientId);
                req.authenticate([{ httpBasic: true }]);
    ...
    RecipientsController.prototype.getTransfers = function (recipientId, page, size, status, createdSince, createdUntil, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.appendTemplatePath(templateObject_6 || (templateObject_6 = tslib_1.__makeTemplateObject(["/recipients/", "/transfers"], ["/recipients/", "/transfers"])), mapped.recipientId);
                req.authenticate([{ httpBasic: true }]);
    ...
    RecipientsController.prototype.getTransfer = function (recipientId, transferId, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.appendTemplatePath(templateObject_7 || (templateObject_7 = tslib_1.__makeTemplateObject(["/recipients/", "/transfers/", ""], ["/recipients/", "/transfers/", ""])), mapped.recipientId, mapped.transferId);
                req.authenticate([{ httpBasic: true }]);
    ...
    RecipientsController.prototype.createWithdraw = function (recipientId, request, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.json(mapped.request);
                req.appendTemplatePath(templateObject_8 || (templateObject_8 = tslib_1.__makeTemplateObject(["/recipients/", "/withdrawals"], ["/recipients/", "/withdrawals"])), mapped.recipientId);
                req.authenticate([{ httpBasic: true }]);
                return [2 /*return*/, req.callAsJson(getWithdrawResponse_1.getWithdrawResponseSchema, requestOptions)];
            });
        });
    ...
    RecipientsController.prototype.getAnticipation = function (recipientId, anticipationId, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.appendTemplatePath(templateObject_9 || (templateObject_9 = tslib_1.__makeTemplateObject(["/recipients/", "/anticipations/", ""], ["/recipients/", "/anticipations/", ""])), mapped.recipientId, mapped.anticipationId);
                req.authenticate([{ httpBasic: true }]);
    ...
    RecipientsController.prototype.updateRecipientTransferSettings = function (recipientId, request, idempotencyKey, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.header('idempotency-key', mapped.idempotencyKey);
                req.json(mapped.request);
                req.appendTemplatePath(templateObject_10 || (templateObject_10 = tslib_1.__makeTemplateObject(["/recipients/", "/transfer-settings"], ["/recipients/", "/transfer-settings"])), mapped.recipientId);
                req.authenticate([{ httpBasic: true }]);
                return [2 /*return*/, req.callAsJson(getRecipientResponse_1.getRecipientResponseSchema, requestOptions)];
            });
        });
    ...
    RecipientsController.prototype.getRecipientByCode = function (code, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.appendTemplatePath(templateObject_11 || (templateObject_11 = tslib_1.__makeTemplateObject(["/recipients/", ""], ["/recipients/", ""])), mapped.code);
                req.authenticate([{ httpBasic: true }]);
                return [2 /*return*/, req.callAsJson(getRecipientResponse_1.getRecipientResponseSchema, requestOptions)];
            });
        });
    ...
    RecipientsController.prototype.updateAutomaticAnticipationSettings = function (recipientId, request, idempotencyKey, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.header('idempotency-key', mapped.idempotencyKey);
                req.json(mapped.request);
                req.appendTemplatePath(templateObject_12 || (templateObject_12 = tslib_1.__makeTemplateObject(["/recipients/", "/automatic-anticipation-settings"], ["/recipients/", "/automatic-anticipation-settings"])), mapped.recipientId);
                req.authenticate([{ httpBasic: true }]);
                return [2 /*return*/, req.callAsJson(getRecipientResponse_1.getRecipientResponseSchema, requestOptions)];
            });
        });
    ...
    RecipientsController.prototype.createTransfer = function (recipientId, request, idempotencyKey, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.header('idempotency-key', mapped.idempotencyKey);
                req.json(mapped.request);
                req.appendTemplatePath(templateObject_13 || (templateObject_13 = tslib_1.__makeTemplateObject(["/recipients/", "/transfers"], ["/recipients/", "/transfers"])), mapped.recipientId);
                req.authenticate([{ httpBasic: true }]);
                return [2 /*return*/, req.callAsJson(getTransferResponse_1.getTransferResponseSchema, requestOptions)];
            });
        });
    ...
    RecipientsController.prototype.createAnticipation = function (recipientId, request, idempotencyKey, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.header('idempotency-key', mapped.idempotencyKey);
                req.json(mapped.request);
                req.appendTemplatePath(templateObject_14 || (templateObject_14 = tslib_1.__makeTemplateObject(["/recipients/", "/anticipations"], ["/recipients/", "/anticipations"])), mapped.recipientId);
                req.authenticate([{ httpBasic: true }]);
                return [2 /*return*/, req.callAsJson(getAnticipationResponse_1.getAnticipationResponseSchema, requestOptions)];
            });
        });
    ...
    RecipientsController.prototype.getAnticipationLimits = function (recipientId, timeframe, paymentDate, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.appendTemplatePath(templateObject_15 || (templateObject_15 = tslib_1.__makeTemplateObject(["/recipients/", "/anticipation_limits"], ["/recipients/", "/anticipation_limits"])), mapped.recipientId);
                req.authenticate([{ httpBasic: true }]);
    ...
    RecipientsController.prototype.updateRecipientMetadata = function (recipientId, request, idempotencyKey, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.header('idempotency-key', mapped.idempotencyKey);
                req.json(mapped.request);
                req.appendTemplatePath(templateObject_16 || (templateObject_16 = tslib_1.__makeTemplateObject(["/recipients/", "/metadata"], ["/recipients/", "/metadata"])), mapped.recipientId);
                req.authenticate([{ httpBasic: true }]);
                return [2 /*return*/, req.callAsJson(getRecipientResponse_1.getRecipientResponseSchema, requestOptions)];
            });
        });
    ...
    RecipientsController.prototype.getAnticipations = function (recipientId, page, size, status, timeframe, paymentDateSince, paymentDateUntil, createdSince, createdUntil, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.query('created_since', mapped.createdSince);
                req.query('created_until', mapped.createdUntil);
                req.appendTemplatePath(templateObject_17 || (templateObject_17 = tslib_1.__makeTemplateObject(["/recipients/", "/anticipations"], ["/recipients/", "/anticipations"])), mapped.recipientId);
                req.authenticate([{ httpBasic: true }]);
    ...
    RecipientsController.prototype.getWithdrawals = function (recipientId, page, size, status, createdSince, createdUntil, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.query('created_since', mapped.createdSince);
                req.query('created_until', mapped.createdUntil);
                req.appendTemplatePath(templateObject_18 || (templateObject_18 = tslib_1.__makeTemplateObject(["/recipients/", "/withdrawals"], ["/recipients/", "/withdrawals"])), mapped.recipientId);
                req.authenticate([{ httpBasic: true }]);
