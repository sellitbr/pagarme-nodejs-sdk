    ...
    InvoicesController.prototype.cancelInvoice = function (invoiceId, idempotencyKey, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.appendTemplatePath(templateObject_1 || (templateObject_1 = tslib_1.__makeTemplateObject(["/invoices/", ""], ["/invoices/", ""])), mapped.invoiceId);
                req.authenticate([{ httpBasic: true }]);
    ...
    InvoicesController.prototype.updateInvoiceStatus = function (invoiceId, request, idempotencyKey, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.appendTemplatePath(templateObject_2 || (templateObject_2 = tslib_1.__makeTemplateObject(["/invoices/", "/status"], ["/invoices/", "/status"])), mapped.invoiceId);
                req.authenticate([{ httpBasic: true }]);
                return [2 /*return*/, req.callAsJson(getInvoiceResponse_1.getInvoiceResponseSchema, requestOptions)];
            });
        });
    ...
    InvoicesController.prototype.updateInvoiceMetadata = function (invoiceId, request, idempotencyKey, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.header('idempotency-key', mapped.idempotencyKey);
                req.json(mapped.request);
                req.appendTemplatePath(templateObject_3 || (templateObject_3 = tslib_1.__makeTemplateObject(["/invoices/", "/metadata"], ["/invoices/", "/metadata"])), mapped.invoiceId);
                req.authenticate([{ httpBasic: true }]);
                return [2 /*return*/, req.callAsJson(getInvoiceResponse_1.getInvoiceResponseSchema, requestOptions)];
            });
        });
    ...
    InvoicesController.prototype.getPartialInvoice = function (subscriptionId, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.appendTemplatePath(templateObject_4 || (templateObject_4 = tslib_1.__makeTemplateObject(["/subscriptions/", "/partial-invoice"], ["/subscriptions/", "/partial-invoice"])), mapped.subscriptionId);
                req.authenticate([{ httpBasic: true }]);
                return [2 /*return*/, req.callAsJson(getInvoiceResponse_1.getInvoiceResponseSchema, requestOptions)];
            });
        });
    ...
    InvoicesController.prototype.createInvoice = function (subscriptionId, cycleId, request, idempotencyKey, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.header('idempotency-key', mapped.idempotencyKey);
                req.json(mapped.request);
                req.appendTemplatePath(templateObject_5 || (templateObject_5 = tslib_1.__makeTemplateObject(["/subscriptions/", "/cycles/", "/pay"], ["/subscriptions/", "/cycles/", "/pay"])), mapped.subscriptionId, mapped.cycleId);
                req.authenticate([{ httpBasic: true }]);
                return [2 /*return*/, req.callAsJson(getInvoiceResponse_1.getInvoiceResponseSchema, requestOptions)];
            });
        });
    ...
    InvoicesController.prototype.getInvoice = function (invoiceId, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.appendTemplatePath(templateObject_6 || (templateObject_6 = tslib_1.__makeTemplateObject(["/invoices/", ""], ["/invoices/", ""])), mapped.invoiceId);
                req.authenticate([{ httpBasic: true }]);
                return [2 /*return*/, req.callAsJson(getInvoiceResponse_1.getInvoiceResponseSchema, requestOptions)];
            });
        });
