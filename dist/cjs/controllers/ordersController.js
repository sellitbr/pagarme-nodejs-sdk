    ...
    OrdersController.prototype.deleteAllOrderItems = function (orderId, idempotencyKey, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.appendTemplatePath(templateObject_1 || (templateObject_1 = tslib_1.__makeTemplateObject(["/orders/", "/items"], ["/orders/", "/items"])), mapped.orderId);
    ...
    OrdersController.prototype.getOrderItem = function (orderId, itemId, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.appendTemplatePath(templateObject_2 || (templateObject_2 = tslib_1.__makeTemplateObject(["/orders/", "/items/", ""], ["/orders/", "/items/", ""])), mapped.orderId, mapped.itemId);
                req.authenticate([{ httpBasic: true }]);
    ...
    OrdersController.prototype.updateOrderMetadata = function (orderId, request, idempotencyKey, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.appendTemplatePath(templateObject_3 || (templateObject_3 = tslib_1.__makeTemplateObject(["/Orders/", "/metadata"], ["/Orders/", "/metadata"])), mapped.orderId);
                req.authenticate([{ httpBasic: true }]);
                return [2 /*return*/, req.callAsJson(getOrderResponse_1.getOrderResponseSchema, requestOptions)];
            });
        });
    ...
    OrdersController.prototype.deleteOrderItem = function (orderId, itemId, idempotencyKey, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.header('idempotency-key', mapped.idempotencyKey);
                req.appendTemplatePath(templateObject_4 || (templateObject_4 = tslib_1.__makeTemplateObject(["/orders/", "/items/", ""], ["/orders/", "/items/", ""])), mapped.orderId, mapped.itemId);
                req.authenticate([{ httpBasic: true }]);
                return [2 /*return*/, req.callAsJson(getOrderItemResponse_1.getOrderItemResponseSchema, requestOptions)];
            });
        });
    ...
    OrdersController.prototype.getOrder = function (orderId, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.appendTemplatePath(templateObject_5 || (templateObject_5 = tslib_1.__makeTemplateObject(["/orders/", ""], ["/orders/", ""])), mapped.orderId);
                req.authenticate([{ httpBasic: true }]);
                return [2 /*return*/, req.callAsJson(getOrderResponse_1.getOrderResponseSchema, requestOptions)];
            });
        });
    ...
    OrdersController.prototype.closeOrder = function (id, request, idempotencyKey, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.header('idempotency-key', mapped.idempotencyKey);
                req.json(mapped.request);
                req.appendTemplatePath(templateObject_7 || (templateObject_7 = tslib_1.__makeTemplateObject(["/orders/", "/closed"], ["/orders/", "/closed"])), mapped.id);
                req.authenticate([{ httpBasic: true }]);
                return [2 /*return*/, req.callAsJson(getOrderResponse_1.getOrderResponseSchema, requestOptions)];
            });
        });
    ...
    OrdersController.prototype.createOrderItem = function (orderId, request, idempotencyKey, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.header('idempotency-key', mapped.idempotencyKey);
                req.json(mapped.request);
                req.appendTemplatePath(templateObject_8 || (templateObject_8 = tslib_1.__makeTemplateObject(["/orders/", "/items"], ["/orders/", "/items"])), mapped.orderId);
                req.authenticate([{ httpBasic: true }]);
                return [2 /*return*/, req.callAsJson(getOrderItemResponse_1.getOrderItemResponseSchema, requestOptions)];
            });
        });
