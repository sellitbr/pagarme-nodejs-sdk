    ...
    ChargesController.prototype.captureCharge = function (chargeId, request, idempotencyKey, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.header('idempotency-key', mapped.idempotencyKey);
                req.json(mapped.request);
                req.appendTemplatePath(templateObject_2 || (templateObject_2 = tslib_1.__makeTemplateObject(["/charges/", "/capture"], ["/charges/", "/capture"])), mapped.chargeId);
                req.authenticate([{ httpBasic: true }]);
                return [2 /*return*/, req.callAsJson(getChargeResponse_1.getChargeResponseSchema, requestOptions)];
            });
        });
    ...
    ChargesController.prototype.getCharge = function (chargeId, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.appendTemplatePath(templateObject_3 || (templateObject_3 = tslib_1.__makeTemplateObject(["/charges/", ""], ["/charges/", ""])), mapped.chargeId);
                req.authenticate([{ httpBasic: true }]);
                return [2 /*return*/, req.callAsJson(getChargeResponse_1.getChargeResponseSchema, requestOptions)];
            });
        });
    ...
    ChargesController.prototype.confirmPayment = function (chargeId, request, idempotencyKey, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.header('idempotency-key', mapped.idempotencyKey);
                req.json(mapped.request);
                req.appendTemplatePath(templateObject_4 || (templateObject_4 = tslib_1.__makeTemplateObject(["/charges/", "/confirm-payment"], ["/charges/", "/confirm-payment"])), mapped.chargeId);
                req.authenticate([{ httpBasic: true }]);
                return [2 /*return*/, req.callAsJson(getChargeResponse_1.getChargeResponseSchema, requestOptions)];
            });
        });
    ...
    ChargesController.prototype.getChargeTransactions = function (chargeId, page, size, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.appendTemplatePath(templateObject_5 || (templateObject_5 = tslib_1.__makeTemplateObject(["/charges/", "/transactions"], ["/charges/", "/transactions"])), mapped.chargeId);
                req.authenticate([{ httpBasic: true }]);
    ...
    ChargesController.prototype.updateChargePaymentMethod = function (chargeId, request, idempotencyKey, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.header('idempotency-key', mapped.idempotencyKey);
                req.json(mapped.request);
                req.appendTemplatePath(templateObject_7 || (templateObject_7 = tslib_1.__makeTemplateObject(["/charges/", "/payment-method"], ["/charges/", "/payment-method"])), mapped.chargeId);
                req.authenticate([{ httpBasic: true }]);
                return [2 /*return*/, req.callAsJson(getChargeResponse_1.getChargeResponseSchema, requestOptions)];
            });
        });
    ...
    ChargesController.prototype.updateChargeDueDate = function (chargeId, request, idempotencyKey, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.header('idempotency-key', mapped.idempotencyKey);
                req.json(mapped.request);
                req.appendTemplatePath(templateObject_8 || (templateObject_8 = tslib_1.__makeTemplateObject(["/Charges/", "/due-date"], ["/Charges/", "/due-date"])), mapped.chargeId);
                req.authenticate([{ httpBasic: true }]);
                return [2 /*return*/, req.callAsJson(getChargeResponse_1.getChargeResponseSchema, requestOptions)];
            });
        });
    ...
    ChargesController.prototype.retryCharge = function (chargeId, idempotencyKey, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.header('idempotency-key', mapped.idempotencyKey);
                req.appendTemplatePath(templateObject_9 || (templateObject_9 = tslib_1.__makeTemplateObject(["/charges/", "/retry"], ["/charges/", "/retry"])), mapped.chargeId);
                req.authenticate([{ httpBasic: true }]);
                return [2 /*return*/, req.callAsJson(getChargeResponse_1.getChargeResponseSchema, requestOptions)];
            });
        });
    ...
    ChargesController.prototype.cancelCharge = function (chargeId, request, idempotencyKey, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.header('idempotency-key', mapped.idempotencyKey);
                req.json(mapped.request);
                req.appendTemplatePath(templateObject_10 || (templateObject_10 = tslib_1.__makeTemplateObject(["/charges/", ""], ["/charges/", ""])), mapped.chargeId);
                req.authenticate([{ httpBasic: true }]);
                return [2 /*return*/, req.callAsJson(getChargeResponse_1.getChargeResponseSchema, requestOptions)];
            });
        });
