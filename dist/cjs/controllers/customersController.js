    ...
    CustomersController.prototype.createAddress = function (customerId, request, idempotencyKey, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.appendTemplatePath(templateObject_1 || (templateObject_1 = tslib_1.__makeTemplateObject(["/customers/", "/addresses"], ["/customers/", "/addresses"])), mapped.customerId);
    ...
    CustomersController.prototype.updateCard = function (customerId, cardId, request, idempotencyKey, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.header('idempotency-key', mapped.idempotencyKey);
                req.json(mapped.request);
                req.appendTemplatePath(templateObject_2 || (templateObject_2 = tslib_1.__makeTemplateObject(["/customers/", "/cards/", ""], ["/customers/", "/cards/", ""])), mapped.customerId, mapped.cardId);
                req.authenticate([{ httpBasic: true }]);
    ...
    CustomersController.prototype.deleteAccessTokens = function (customerId, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.appendTemplatePath(templateObject_4 || (templateObject_4 = tslib_1.__makeTemplateObject(["/customers/", "/access-tokens/"], ["/customers/", "/access-tokens/"])), mapped.customerId);
                req.authenticate([{ httpBasic: true }]);
    ...
    CustomersController.prototype.updateAddress = function (customerId, addressId, request, idempotencyKey, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.header('idempotency-key', mapped.idempotencyKey);
                req.json(mapped.request);
                req.appendTemplatePath(templateObject_5 || (templateObject_5 = tslib_1.__makeTemplateObject(["/customers/", "/addresses/", ""], ["/customers/", "/addresses/", ""])), mapped.customerId, mapped.addressId);
                req.authenticate([{ httpBasic: true }]);
                return [2 /*return*/, req.callAsJson(getAddressResponse_1.getAddressResponseSchema, requestOptions)];
            });
        });
    ...
    CustomersController.prototype.getAccessTokens = function (customerId, page, size, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.query('page', mapped.page);
                req.query('size', mapped.size);
                req.appendTemplatePath(templateObject_8 || (templateObject_8 = tslib_1.__makeTemplateObject(["/customers/", "/access-tokens"], ["/customers/", "/access-tokens"])), mapped.customerId);
                req.authenticate([{ httpBasic: true }]);
                return [2 /*return*/, req.callAsJson(listAccessTokensResponse_1.listAccessTokensResponseSchema, requestOptions)];
            });
        });
    ...
    CustomersController.prototype.deleteCard = function (customerId, cardId, idempotencyKey, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.header('idempotency-key', mapped.idempotencyKey);
                req.appendTemplatePath(templateObject_9 || (templateObject_9 = tslib_1.__makeTemplateObject(["/customers/", "/cards/", ""], ["/customers/", "/cards/", ""])), mapped.customerId, mapped.cardId);
                req.authenticate([{ httpBasic: true }]);
                return [2 /*return*/, req.callAsJson(getCardResponse_1.getCardResponseSchema, requestOptions)];
            });
        });
    ...
    CustomersController.prototype.getCard = function (customerId, cardId, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.appendTemplatePath(templateObject_10 || (templateObject_10 = tslib_1.__makeTemplateObject(["/customers/", "/cards/", ""], ["/customers/", "/cards/", ""])), mapped.customerId, mapped.cardId);
                req.authenticate([{ httpBasic: true }]);
                return [2 /*return*/, req.callAsJson(getCardResponse_1.getCardResponseSchema, requestOptions)];
            });
        });
    ...
    CustomersController.prototype.createCard = function (customerId, request, idempotencyKey, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.header('idempotency-key', mapped.idempotencyKey);
                req.json(mapped.request);
                req.appendTemplatePath(templateObject_11 || (templateObject_11 = tslib_1.__makeTemplateObject(["/customers/", "/cards"], ["/customers/", "/cards"])), mapped.customerId);
                req.authenticate([{ httpBasic: true }]);
                return [2 /*return*/, req.callAsJson(getCardResponse_1.getCardResponseSchema, requestOptions)];
            });
        });
    ...
    CustomersController.prototype.getAccessToken = function (customerId, tokenId, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.appendTemplatePath(templateObject_12 || (templateObject_12 = tslib_1.__makeTemplateObject(["/customers/", "/access-tokens/", ""], ["/customers/", "/access-tokens/", ""])), mapped.customerId, mapped.tokenId);
                req.authenticate([{ httpBasic: true }]);
                return [2 /*return*/, req.callAsJson(getAccessTokenResponse_1.getAccessTokenResponseSchema, requestOptions)];
            });
        });
    ...
    CustomersController.prototype.getAddresses = function (customerId, page, size, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.query('page', mapped.page);
                req.query('size', mapped.size);
                req.appendTemplatePath(templateObject_13 || (templateObject_13 = tslib_1.__makeTemplateObject(["/customers/", "/addresses"], ["/customers/", "/addresses"])), mapped.customerId);
                req.authenticate([{ httpBasic: true }]);
    ...
    CustomersController.prototype.updateCustomer = function (customerId, request, idempotencyKey, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.header('idempotency-key', mapped.idempotencyKey);
                req.json(mapped.request);
                req.appendTemplatePath(templateObject_14 || (templateObject_14 = tslib_1.__makeTemplateObject(["/customers/", ""], ["/customers/", ""])), mapped.customerId);
                req.authenticate([{ httpBasic: true }]);
                return [2 /*return*/, req.callAsJson(getCustomerResponse_1.getCustomerResponseSchema, requestOptions)];
            });
        });
    ...
    CustomersController.prototype.createAccessToken = function (customerId, request, idempotencyKey, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.header('idempotency-key', mapped.idempotencyKey);
                req.json(mapped.request);
                req.appendTemplatePath(templateObject_15 || (templateObject_15 = tslib_1.__makeTemplateObject(["/customers/", "/access-tokens"], ["/customers/", "/access-tokens"])), mapped.customerId);
                req.authenticate([{ httpBasic: true }]);
                return [2 /*return*/, req.callAsJson(getAccessTokenResponse_1.getAccessTokenResponseSchema, requestOptions)];
            });
        });
    ...
    CustomersController.prototype.getCards = function (customerId, page, size, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.query('page', mapped.page);
                req.query('size', mapped.size);
                req.appendTemplatePath(templateObject_16 || (templateObject_16 = tslib_1.__makeTemplateObject(["/customers/", "/cards"], ["/customers/", "/cards"])), mapped.customerId);
                req.authenticate([{ httpBasic: true }]);
    ...
    CustomersController.prototype.renewCard = function (customerId, cardId, idempotencyKey, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.header('idempotency-key', mapped.idempotencyKey);
                req.appendTemplatePath(templateObject_17 || (templateObject_17 = tslib_1.__makeTemplateObject(["/customers/", "/cards/", "/renew"], ["/customers/", "/cards/", "/renew"])), mapped.customerId, mapped.cardId);
                req.authenticate([{ httpBasic: true }]);
                return [2 /*return*/, req.callAsJson(getCardResponse_1.getCardResponseSchema, requestOptions)];
            });
        });
    ...
    CustomersController.prototype.updateCustomerMetadata = function (customerId, request, idempotencyKey, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.header('idempotency-key', mapped.idempotencyKey);
                req.json(mapped.request);
                req.appendTemplatePath(templateObject_18 || (templateObject_18 = tslib_1.__makeTemplateObject(["/Customers/", "/metadata"], ["/Customers/", "/metadata"])), mapped.customerId);
                req.authenticate([{ httpBasic: true }]);
                return [2 /*return*/, req.callAsJson(getCustomerResponse_1.getCustomerResponseSchema, requestOptions)];
            });
        });
    ...
    CustomersController.prototype.getCustomer = function (customerId, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                req = this.createRequest('GET');
                mapped = req.prepareArgs({ customerId: [customerId, (0, schema_1.string)()] });
                req.appendTemplatePath(templateObject_19 || (templateObject_19 = tslib_1.__makeTemplateObject(["/customers/", ""], ["/customers/", ""])), mapped.customerId);
                req.authenticate([{ httpBasic: true }]);
                return [2 /*return*/, req.callAsJson(getCustomerResponse_1.getCustomerResponseSchema, requestOptions)];
            });
        });
