...
exports.getPixTransactionResponseSchema = void 0;
...
var getPixPayerResponse_1 = require("./getPixPayerResponse");
var getSplitResponse_1 = require("./getSplitResponse");
var pixAdditionalInformation_1 = require("./pixAdditionalInformation");
exports.getPixTransactionResponseSchema = (0, schema_1.object)({
    qrCode: ['qr_code', (0, schema_1.optional)((0, schema_1.nullable)((0, schema_1.string)()))],
    qrCodeUrl: ['qr_code_url', (0, schema_1.optional)((0, schema_1.nullable)((0, schema_1.string)()))],
    expiresAt: ['expires_at', (0, schema_1.optional)((0, schema_1.nullable)((0, schema_1.string)()))],
    additionalInformation: [
        'additional_information',
        (0, schema_1.optional)((0, schema_1.nullable)((0, schema_1.array)((0, schema_1.lazy)(function () { return pixAdditionalInformation_1.pixAdditionalInformationSchema; })))),
    ],
    endToEndId: ['end_to_end_id', (0, schema_1.optional)((0, schema_1.nullable)((0, schema_1.string)()))],
    payer: ['payer', (0, schema_1.optional)((0, schema_1.nullable)((0, schema_1.lazy)(function () { return getPixPayerResponse_1.getPixPayerResponseSchema; })))],
    pixProviderTid: ['pix_provider_tid', (0, schema_1.optional)((0, schema_1.nullable)((0, schema_1.string)()))],
    ...
    transactionType: ['transaction_type', (0, schema_1.optional)((0, schema_1.literal)('pix'))]
});
//# sourceMappingURL=getPixTransactionResponse.js.map